...
const testimonials = [
  {
    ...
    imageSrc: 'https://img.freepik.com/premium-photo/portrait-smiling-black-man-image-generated-by-ai_803126-1314.jpg', // Replace with actual image path
    imageAlt: 'John',
  },
  {
    name: 'Jane, Eldoret',
    text: 'The e-learning courses improved my farming skills tremendously.',
    imageSrc: 'https://cdn270-genai.picsart.com/f170f707-a20e-42aa-9760-b5941abc1297/475621005023201.jpg', // Replace with actual image path
    imageAlt: 'Jane',
  },
  {
    name: 'Peter, Nairobi',
    text: 'I\'ve accessed funding I never knew existed before!',
    imageSrc: 'https://img.freepik.com/premium-photo/photo-closeup-portrait-young-man-profile-view_1077802-269144.jpg', // Replace with actual image path
    imageAlt: 'Peter',
  },
];
...
const HomePage: React.FC = () => {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-screen flex items-center justify-center text-center">
        <video autoPlay loop muted playsInline className="absolute top-0 left-0 w-full h-full object-cover">
          <source src="https://v.ftcdn.net/02/07/55/53/700_F_207555361_UH9d10tGKSNfmBYu3nK3pFnIyYV7mxB6_ST.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>
        <div className="absolute inset-0 bg-black bg-opacity-40"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl font-bold text-white mb-6">Empowering Farmers, Connecting Communities</h1>
          <p className="text-xl text-gray-200 mb-8">
            Shambalink is your gateway to modern agriculture. Connect with buyers, learn best practices, and grow your business.
          </p>
          <div className="space-x-4">
            <button className="bg-green-600 text-white px-6 py-3 rounded-md hover:bg-green-700 transition-colors">Get Started</button>
            <button className="bg-white text-green-600 px-6 py-3 rounded-md hover:bg-green-50 transition-colors">Learn More</button>
          </div>
        </div>
      </div>
       {/* Features Section */}
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div
          ...
          style={{ backgroundImage: 'url(/path-to-market-access-image.jpg)' }} // Replace with actual image path
        >
          ...
          <p className="text-gray-600 group-hover:text-white">
            Connect directly with buyers and sell your products at fair prices.
          </p>
        </div>
        ...
        <div
          className="relative bg-white p-6 rounded-lg shadow-lg text-center transition-all duration-500 transform hover:scale-105 hover:translate-y-2 group"
          style={{ backgroundImage: 'url(/path-to-opportunities-image.jpg)' }} // Replace with actual image path
        >
          <div className="mb-4 flex justify-center">
    ...
    <h2 className="text-3xl font-bold text-green-800 mb-8">Success Stories</h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div className="flex items-center justify-center mb-8">
      ...
      <h2 className="text-3xl font-bold text-green-800">Get the Shambalink App</h2>
    </div>
    ...
    <p className="text-lg text-gray-700 mb-8">
      Download the app for real-time notifications and seamless transactions.
    </p>
    ...
    <div className="flex justify-center space-x-4">
      <a
        ...
        style={{
          backgroundImage: 'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcLwBFEP8AZ8tUiJtH1JgUT8l0Sw7z5O19Yg&s)', // Replace with your App Store logo path
        }}
      />
      <a
        ...
        className="w-32 h-12 bg-cover bg-no-repeat rounded-md"
        style={{
          backgroundImage: 'url(https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Google_Play_Store_badge_EN.svg/2560px-Google_Play_Store_badge_EN.svg.png)', // Replace with your Play Store logo path
        }}
      />
    </div>
  </section>
